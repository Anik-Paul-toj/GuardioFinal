          ...
          },
          {
            ...
            onPress: async () => {
              try {
                ...
                const canOpen = await Linking.canOpenURL(metamaskDirectLink);
                if (canOpen) {
